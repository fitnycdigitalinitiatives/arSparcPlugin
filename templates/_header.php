...
<header id="top-bar">
  ...
  <?php if (sfConfig::get('app_toggleLogo')): ?>
    <?php echo link_to(image_tag('/plugins/arSparcPlugin/images/sparc.png', array('alt' => 'FIT Special Collections and College Archives')), '@homepage', array('id' => 'logo', 'rel' => 'home')) ?>
  <?php endif; ?>
